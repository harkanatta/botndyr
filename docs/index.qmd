...
##  Kolgrafafjörður {background-image="images/2.png"}
...
*  At first our aim was to investigate the immediate impacts of a catastrophe.
* But as the project sparked interes we sought to examine:
...
::: aside
drawing from the work of others (<span style="font-size:20pt;">[Eivind Oug, Tor Eiliv Lein, Regina Küfner & Inger-Britt Falk-Petersen]{.monash-blue2} (1991)</span>)
